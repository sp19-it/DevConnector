...
router.post(
  ...
  (req, res) => {
    ...
    // Get fields (fill up the empty textboxes). Since it includes "optional" we write if statement and only fill up the given information in profileFields object
    const profileFields = {};
